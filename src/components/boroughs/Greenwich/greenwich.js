          ...
          <Nav path={IMAGES[5].url} titlewrap="titlewraplocations" title="areas" />
            ...
            {windowWidth >= 900 ? (
              <div>
                ...
                <Overlay data_number={2} image_number={8} position="nat_museum_hover" />
               ...
               <animated.img className="queens_house_parallax parallax" style={{ transform: props.xy.to(queens) }} src = {IMAGES[6].url}   alt="queens house"/>
               <animated.img className="royal_observatory_parallax parallax" style={{ transform: props.xy.to(obser) }} src = {IMAGES[7].url}  alt="royal observatory"/>
               <animated.img className="martime_museum_parallax parallax" style={{ transform: props.xy.to(natmu) }} src = {IMAGES[8].url}   alt="national maritime"/>
               </div>
               </div>
              ...
              <div>
               ...
               <img className="cable_car_static" src = {IMAGES[9].url}  alt="cable car"/>
               <div style={{display: "flex", justifyContent:"center"}}>
               <h1>{data[2].title}</h1>
               <Overlay data_number={2}  image_number={8}/>
               </div>
               <img className="martime_museum_static" src = {IMAGES[8].url}  alt="national maritime"/>

               <div style={{display: "flex", justifyContent:"center"}}>
                <h1>{data[3].title}</h1>
                <Overlay data_number={3}  image_number={6}/>
                </div>
                <img className="queens_house_static" src = {IMAGES[6].url}   alt="queens house"/>
                ...
                <img className="royal_observatory_static" src = {IMAGES[7].url}   alt="royal observatory"/>
                </div>
              </div>
              </div>
            )}
