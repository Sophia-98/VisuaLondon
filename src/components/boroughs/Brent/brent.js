...
// location and parallax strength configurations
    ...
    <div>
      ...
      {windowWidth >= 900 ? (
        <div>
          ...
          <div
            className="container_borough bg_container brent_bg "
        ...
        <div className="container_borough bg_static">
          <div className="image_stack">
            ...
            <img alt="Neasden Temple" className="temple" src={IMAGES[4].url} />
          </div>
        </div>
      )}
    </div>
