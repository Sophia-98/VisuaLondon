...
const cathe = (x, y) => `translate3d(${x / 20+450}px,${y / 30}px,0)`
const shakes = (x, y) => `translate3d(${x / 30-520}px,${y / 180+110}px,0)`
          ...
          <Nav path='../assets/locations/Southwark/Logo.png' titlewrap="titlewraplocations" title="areas" />
            ...
            {windowWidth >= 900 ? (
              <div>
                ...
                <animated.img className="shakesp parallax" style={{ transform: props.xy.to(shakes) }} src ='../assets/locations/Southwark/shakespeare.png'/>
              ...
              <div>
               ...
               <img className="market_static" src ='../assets/locations/Southwark/borough_market.png' alt="borugh Market"/>
               ...
               <div style={{display: "flex", justifyContent:"center"}}>
                ...
                <img className="globe_static" src ='../assets/locations/Southwark/shakespeare.png' alt="shakespeare"/>
